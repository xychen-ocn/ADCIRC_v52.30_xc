...
ifeq ($(compiler),intel)
  ...
  #FFLAGS1       :=  $(INCDIRS) -O2 -FI -assume byterecl -132 -shared-intel -assume buffered_io -xAVX -traceback
  FFLAGS1       :=  $(INCDIRS) -O2 -FI -assume byterecl -132 -assume buffered_io -xAVX -traceback
  ifeq ($(DEBUG),full)
  ...
  ifeq ($(NETCDF),enable)
     ifeq ($(MACHINENAME),hatteras)
        FLIBS       := $(FLIBS) -L/usr/share/Modules/software/CentOS-7/netcdf-Fortran/4.4.0_intel-18.0.0/lib -lnetcdff -lnetcdf
        NETCDFHOME    :=/usr/share/Modules/software/CentOS-7/netcdf-Fortran/4.4.0_intel-18.0.0
        FFLAGS1       :=$(FFLAGS1) -I/usr/share/Modules/software/CentOS-7/netcdf-Fortran/4.4.0_intel-18.0.0/include
        FFLAGS2       :=$(FFLAGS1)
        FFLAGS3       :=$(FFLAGS1)
     endif
